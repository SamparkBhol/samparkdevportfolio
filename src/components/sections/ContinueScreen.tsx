    ...
    >
      ...
      <div className="relative grid gap-8 md:grid-cols-[1.6fr_1fr]">
        ...
        >
          ...
          {/* Subtle 3D depth on the CRT chassis. glare off so it never washes
              the REPL text; Tilt only listens to pointer move (no key/focus
              capture) so terminal input + typing tests stay intact. */}
        ...
        >
          {/* Tilt the whole socials card for subtle depth (pointer-only). */}
          <Tilt max={5}>
          <Panel color="yellow" lg className="relative p-6">
            ...
            <SpeechBubble className="mb-5 -rotate-1 text-sm">
              ...
              <Magnetic strength={0.3} className="align-baseline">
                <a
